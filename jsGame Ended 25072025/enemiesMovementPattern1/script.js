...
class Enemy {
    constructor() {
        ...
        this.image.src = '../src/img/enemies/enemy1.png'; // Define o caminho da imagem do sprite
        this.spriteWidth = 293; // Largura de cada quadro do sprite
        this.spriteHeight = 155; // Altura de cada quadro do sprite
        ...
        this.flapSpeed = Math.floor(Math.random() * 8 + 4); // Velocidade aleatória de troca de quadros (4 a 11)
    }
    // Atualiza a posição e animação do inimigo
    update() {
        this.x += Math.random() * 15 - 7.5; // Move o inimigo horizontalmente de forma aleatória (-7.5 a 7.5)
        this.y += Math.random() * 15 - 7.5; // Move o inimigo verticalmente de forma aleatória (-7.5 a 7.5)
