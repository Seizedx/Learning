...
export default function RegisterFirestoreDatabase() {
    ...
    async function handleRegister() {
        ...
        //maneira 1 seta valor a um key especifica, no caso o 3
    ...
    // }
        ...
        //maneira 2 utilizando o addDoc, gera valor aleatório no document
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.buttonArea}>
                    ...
                    >
                        <Text style={styles.buttonText}>Add Item to Firestore Database</Text>
                    </TouchableOpacity>
                </View>
            </View>
        )
